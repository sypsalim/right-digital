...
function calculateAndUpdate() {
  ...
  if (isBagsMode) {
    ...
    fullBagH = topFold + bagH + bottomFold; // 2 cm Top fold + H + Bottom fold
        ...
        if (!partFits) {
          ...
          boxFoldNotice.innerHTML = `
            ...
            <div style="font-size: 0.82rem; opacity: 0.9;">
              ...
              Each Part Size: <strong>${partBagW.toFixed(1)} × ${partBagH.toFixed(1)} cm</strong> (Joint 1.5 cm + Length ${i_w} cm + Gusset ${i_h} cm | Top Fold 2.0 cm + Height ${boxH} cm + Bottom Flap ${bottomFoldVal.toFixed(1)} cm)<br>
